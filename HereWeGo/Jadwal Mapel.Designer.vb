...
Partial Class Jadwal_Mapel
    ...
    Private Sub InitializeComponent()
        ...
        id_jadwal = New DataGridViewTextBoxColumn()
        id_kelas = New DataGridViewTextBoxColumn()
        id_mapel = New DataGridViewTextBoxColumn()
        nip = New DataGridViewTextBoxColumn()
        hari = New DataGridViewTextBoxColumn()
        jam_mulai = New DataGridViewTextBoxColumn()
        jam_selesai = New DataGridViewTextBoxColumn()
        ...
        DataGridView1.Columns.AddRange(New DataGridViewColumn() {id_jadwal, id_kelas, id_mapel, nip, hari, jam_mulai, jam_selesai, status})
        ...
        ' id_jadwal
        ' 
        id_jadwal.HeaderText = "Id Jadwal"
        id_jadwal.MinimumWidth = 6
        id_jadwal.Name = "id_jadwal"
        id_jadwal.ReadOnly = True
        id_jadwal.Width = 180
        ' 
        ' id_kelas
        ' 
        id_kelas.HeaderText = "Kelas"
        ...
        ' id_mapel
        ' 
        id_mapel.HeaderText = "Mata Pelajaran"
        ...
        ' jam_mulai
        ' 
        jam_mulai.HeaderText = "Jam Mulai"
        jam_mulai.MinimumWidth = 6
        jam_mulai.Name = "jam_mulai"
        jam_mulai.ReadOnly = True
        jam_mulai.Width = 125
        ' 
        ' jam_selesai
        ' 
        jam_selesai.HeaderText = "Jam Selesai"
        jam_selesai.MinimumWidth = 6
        jam_selesai.Name = "jam_selesai"
        jam_selesai.ReadOnly = True
        jam_selesai.Width = 125
        ' 
        ' status
        ' 
    ...
    Friend WithEvents id_jadwal As DataGridViewTextBoxColumn
